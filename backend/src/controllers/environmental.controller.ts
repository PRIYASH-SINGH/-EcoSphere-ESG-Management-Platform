...
export class EnvironmentalController {
  ...
  createEmissionFactor = async (
    ...
    try {
      const factor = this.service.createEmissionFactor(req.body);
  ...
  getAllEmissionFactors = async (
    _req: Request,
    res: Response
  ): Promise<void> => {
    try {
      const factors = this.service.getAllEmissionFactors();
  ...
  updateEmissionFactor = async (
    ...
    try {
      ...
      const factor = this.service.updateEmissionFactor(id, req.body);
  ...
  deleteEmissionFactor = async (
    ...
    try {
      ...
      this.service.deleteEmissionFactor(id);
  ...
  createCarbonTransaction = async (
    req: Request,
    res: Response
  ): Promise<void> => {
    try {
      const transaction = this.service.createCarbonTransaction(req.body);
  ...
  getCarbonTransactions = async (
    ...
    try {
      ...
      const transactions = this.service.getCarbonTransactions(filters);
  ...
  getCarbonSummary = async (
    ...
    try {
      ...
      const summary = this.service.getCarbonSummary(filters);
  ...
  getGoals = async (req: Request, res: Response): Promise<void> => {
    try {
      ...
      const goals = this.service.getGoals(departmentId);
  ...
  updateGoalProgress = async (
    ...
    try {
      ...
      const goal = this.service.updateGoalProgress(id, req.body.currentValue);
